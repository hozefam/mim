$(document).ready(function () {
  ...
  $(document).on('click', function (e) {
    if (
      $(e.target).is('.searchForm__input,.searchForm__buttonSearch') === false
    ) {
  ...
  if (browser != 12) {
    ...
    $('.svg-div-2').css(
      'cssText',
      'background-image:url("img/svg2.gif");background-repeat: no-repeat;background-position: center;'
    );
    $('.svg-div-1').css(
      'cssText',
      'background-image:url("img/svg1.gif");background-repeat: no-repeat;background-position: center;'
    );
  } else {
    AOS.init({
      once: true,
